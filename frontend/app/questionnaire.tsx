...
export default function QuestionnaireScreen() {
  ...
  const contextData = params.contextData ? JSON.parse(params.contextData as string) : null;
  ...
  const handleFinish = () => {
    ...
    router.push({
      pathname: '/results',
      params: { evaluationData: JSON.stringify(evaluationData) }
    });
  };
